...
1. **Fork the repository**  
   ...
   To fork the repository, click the **Fork** button in the top right corner of this page or click [here to fork the repository](https://github.com/dileepadev/deploying-agentic-ai-apps-workshop/fork).

2. **Clone your fork**  
   Clone your forked repository to your local machine using the following command:

   ```bash
   git clone https://github.com/<your-username>/deploying-agentic-ai-apps-workshop.git
   ```
...
- Refer to the following templates and guidelines before submitting your changes:
  - [deploying-agentic-ai-apps-workshop/](./) - Root directory of the repository
