...
<details>
<summary><code>ModuleNotFoundError: No module named 'tools'</code></summary>
...
Two of the agent's three tools are the ones you just wrote. The third,
...
[`app/agent/research.py`](../05-framework/) rather than in this step. Set
